...
api_key <- "tfFu0don4XCDcKigkktZlfkAc"
api_secret_key <- "B5F9vuRbLCPyFbfxTiH21std7wKfJm7ZVOzKgwf6G6NRujLbsX"
access_token <- "1095044460-vahdfY9jgfvAMKpDzfygtEiVdVnPYoS0DAGs8F8"
access_token_secret <- "mp07boiX6UFiToKtD0F4lyfpux4h4cxnSvhfTk1W81LWs"
...
for (ff in list_ff){
  nam <- ff
  assign(nam, get_timeline(ff, n = 10000))
}
```

```{r, echo = TRUE}
#fisso a 50/50 il rateo con le risposte



#total_ds <- rbind(tacobell, jackbox, popeyeschicken, littlecaesars, 
#               BurgerKing,  PapaJohns ,
#               pizzahut, kfc, wendys , FiveGuys, arbys, 
#               panerabread, whataburger, shakeshack)
